...
// Extracted outside ParallaxGallery to prevent unmount/remount on every re-render.
// Previously defined inside the component body, causing React to treat it as a 
// new component type on each render → full DOM tree teardown and rebuild.
const Column = ({ y, className }: { y: MotionValue<number>; className?: string }) => (
